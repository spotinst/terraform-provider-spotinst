...
* resource/spotinst_ocean_aks_np_virtual_node_group: Added support for `auto_headroom_percentage` field.
...
## 1.230.0 (Oct, 29 2025)
ENHANCEMENTS:
* resource/spotinst_ocean_aws_launch_spec: Added support for `is_aggressive_scale_down_enabled` field.
