		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "master_ebs_block_device.0.volumes_per_instance", "1"),
					resource.TestCheckResourceAttr(resourceName, "master_ebs_block_device.0.volume_type", "gp2"),
					resource.TestCheckResourceAttr(resourceName, "master_ebs_block_device.0.size_in_gb", "10"),
					...
					resource.TestCheckResourceAttr(resourceName, "tags.0.value", "Terraform"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.0.instance_type", "m3.xlarge"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.0.weighted_capacity", "4"),
					...
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.volumes_per_instance", "2"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.volume_type", "gp2"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.size_in_gb", "40"),
				),
			},
			{
				Config: createMRScalerAWSTerraform(&MRScalerAWSConfigMetaData{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tags.0.value", "Terraform"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.0.instance_type", "m2.xlarge"),
					resource.TestCheckResourceAttr(resourceName, "instance_weights.0.weighted_capacity", "5"),
					resource.TestCheckResourceAttr(resourceName, "keep_job_flow_alive", "true"),
					resource.TestCheckResourceAttr(resourceName, "task_instance_types.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "task_instance_types.0", "c3.xlarge"),
					...
					resource.TestCheckResourceAttr(resourceName, "task_unit", "instance"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.volumes_per_instance", "1"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.volume_type", "gp2"),
					resource.TestCheckResourceAttr(resourceName, "task_ebs_block_device.0.size_in_gb", "30"),
				),
			},
		},
	})
