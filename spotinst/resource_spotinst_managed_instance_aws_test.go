		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "subnet_ids.2", "subnet-09b7d9127de5d49d8"),
...
resource "` + string(commons.ManagedInstanceAWSResourceName) + `" "%v" {
  ...
  subnet_ids = ["subnet-0faad0b6bb7e99d9f", "subnet-0bd585d2c2177c7ee", "subnet-09b7d9127de5d49d8"]
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.record_set_type", ""),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.record_sets.3142519941.use_public_dns", "false"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_set_type", ""),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.324056474.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.409274120.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.2501457915.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_set_type", ""),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.2228261234.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.4062604560.use_public_dns", "false"),
