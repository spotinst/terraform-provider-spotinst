		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.0.use_public_dns", "false"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.1.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.2.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1.record_sets.0.use_public_dns", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1.record_sets.1.use_public_dns", "false"),
