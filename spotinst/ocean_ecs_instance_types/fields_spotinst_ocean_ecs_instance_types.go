	...
	fieldsMap[Whitelist] = commons.NewGenericField(
		...
		func(resourceObject interface{}, resourceData *schema.ResourceData, meta interface{}) error {
			...
			if v, ok := resourceData.GetOk(string(Whitelist)); ok {
				if whitelist, err := expandECSInstanceTypeList(v); err != nil {
					return err
				} else {
	...
	fieldsMap[Blacklist] = commons.NewGenericField(
		...
		func(resourceObject interface{}, resourceData *schema.ResourceData, meta interface{}) error {
			...
			if v, ok := resourceData.GetOk(string(Blacklist)); ok {
				if blacklist, err := expandECSInstanceTypeList(v); err != nil {
					return err
				} else {
	...
	fieldsMap[Filters] = commons.NewGenericField(
		...
		func(resourceObject interface{}, resourceData *schema.ResourceData, meta interface{}) error {
			...
			if cluster.Compute.InstanceTypes == nil {
				cluster.Compute.InstanceTypes = &aws.ECSInstanceTypes{}
			}
...
func expandFilters(data interface{}, nullify bool) (*aws.ECSFilters, error) {
	...
	if v, ok := m[string(Architectures)]; ok {
		architectures, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(Categories)]; ok {
		categories, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(DiskTypes)]; ok {
		diskTypes, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(ExcludeFamilies)]; ok {
		excludeFamilies, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(Hypervisor)]; ok {
		hypervisor, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(IncludeFamilies)]; ok {
		includeFamilies, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(RootDeviceTypes)]; ok {
		rootDevicetypes, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
	...
	if v, ok := m[string(VirtualizationTypes)]; ok {
		virtualizationtypes, err := expandECSInstanceTypeFiltersList(v)
		if err != nil {
			return nil, err
		}
...
func expandECSInstanceTypeList(data interface{}) ([]string, error) {
	list := data.([]interface{})
...
func expandECSInstanceTypeFiltersList(data interface{}) ([]string, error) {
...
func flattenFilters(filters *aws.ECSFilters) []interface{} {
	var out []interface{}
