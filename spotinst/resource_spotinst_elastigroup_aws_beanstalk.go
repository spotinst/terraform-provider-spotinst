...
import (
	...
	"github.com/spotinst/terraform-provider-spotinst/spotinst/elastigroup_aws_beanstalk"
	"github.com/spotinst/terraform-provider-spotinst/spotinst/elastigroup_aws_beanstalk_scheduled_task"
)
