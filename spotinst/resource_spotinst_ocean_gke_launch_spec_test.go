		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "shielded_instance_config.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "shielded_instance_config.3046986788.enable_integrity_monitoring", "true"),
					resource.TestCheckResourceAttr(resourceName, "shielded_instance_config.3046986788.enable_secure_boot", "false"),
					resource.TestCheckResourceAttr(resourceName, "storage.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "storage.3717536058.local_ssd_count", "5"),
					resource.TestCheckResourceAttr(resourceName, "resource_limits.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "resource_limits.4247406351.max_instance_count", "3"),
				),
			},
		},
	})
