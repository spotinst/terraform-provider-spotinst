		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "managed_service_identity.3032724944.resource_group_name", "AutomationResourceGroup"),
					resource.TestCheckResourceAttr(resourceName, "managed_service_identity.3032724944.name", "AutomationResourceIdentity2"),
				),
			},
		},
	})
