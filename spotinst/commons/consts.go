...
const (
	...
	StatefulNodeAzureCompute                  ResourceAffinity = "Stateful_Node_Azure_Compute"
	...
	StatefulNodeAzureManagedServiceIdentities ResourceAffinity = "Stateful_Node_Azure_Managed_Service_Identities"
