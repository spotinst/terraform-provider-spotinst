...
const (
	...
	ElastigroupAzureScheduling          ResourceAffinity = "Elastigroup_Azure_Scheduling"
	ElastigroupAzureLaunchSpecification ResourceAffinity = "Elastigroup_Azure_Launch_Specification"
	ElastirgoupAzureExtensions          ResourceAffinity = "Elastigroup_Azure_Extensions"
	ElastigroupAzureSecret              ResourceAffinity = "Elastigroup_Azure_Secret"
	ElastigroupAzureLoadBalancer        ResourceAffinity = "Elastigroup_Azure_Load_Balancer"
	ElastigroupAzureHealth              ResourceAffinity = "Elastigroup_Azure_Health"
