...
func (credentialWrapper *AWSCredentialWrapper) GetCredential() *aws.Credentials {
	return credentialWrapper.credential
}

func (credentialWrapper *AWSCredentialWrapper) SetCredential(credential *aws.Credentials) {
