		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.0.device_name", "/dev/sdb"),
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.0.volume_size", "12"),
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1.delete_on_termination", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1.device_name", "/dev/sda"),
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1.volume_size", "8"),
