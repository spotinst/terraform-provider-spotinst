		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.1.name", "test_update_two"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.1.use_public_ip", "false"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.0.record_sets.2.name", "test_update_three"),
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1.record_sets.1.use_public_ip", "false"),
				),
			},
			{
				ResourceName: resourceName,
