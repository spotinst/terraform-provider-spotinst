		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1523824956.delete_on_termination", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1523824956.device_name", "/dev/sdb"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1523824956.encrypted", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1523824956.iops", "1"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.1523824956.snapshot_id", ""),
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3299715593.snapshot_id", ""),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3299715593.volume_size", "8"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3299715593.volume_type", "GP3"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3299715593.throughput", "500"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.delete_on_termination", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.device_name", "/dev/sda"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.encrypted", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.iops", "1"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.snapshot_id", ""),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.volume_size", "10"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.volume_type", "GP3"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.865355886.throughput", "500"),
