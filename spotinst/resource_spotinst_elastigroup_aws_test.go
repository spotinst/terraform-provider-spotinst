		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckElastigroupAttributes(&group, groupName),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.policy_name", "policy-name-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.source", "spectrum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.statistic", "sum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.unit", "bytes"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.is_enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.cooldown", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.0.name", "name-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.0.value", "value-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.threshold", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.operator", "lt"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.evaluation_periods", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.period", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.action_type", "adjustment"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.adjustment", "MAX(5,10)"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.min_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.max_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.maximum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.minimum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.target", ""),
