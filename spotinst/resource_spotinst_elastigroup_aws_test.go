...
resource "` + string(commons.ElastigroupAWSResourceName) + `" "%v" {
	...
	// --- SUBNET IDS -------------------
	region      = "us-west-2"
	subnet_ids  = ["subnet-0faad0b6bb7e99d9f", "subnet-051ada52cd4f9a2d9"]
	// ----------------------------------
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.policy_name", "policy-name"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.source", "cloudWatch"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.statistic", "average"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.unit", "percent"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.is_enabled", "false"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.cooldown", "60"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.0.name", "name-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.dimensions.0.value", "value-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.threshold", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.operator", "gt"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.evaluation_periods", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.period", "60"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.action_type", "setMinTarget"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.min_target_capacity", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.adjustment", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.max_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.maximum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.minimum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.3591206139.target", ""),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckElastigroupAttributes(&group, groupName),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.policy_name", "policy-name-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.source", "spectrum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.statistic", "sum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.unit", "bytes"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.is_enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.cooldown", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.dimensions.0.name", "name-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.dimensions.0.value", "value-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.threshold", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.operator", "lt"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.evaluation_periods", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.period", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.action_type", "adjustment"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.adjustment", "MAX(5,10)"),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.min_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.max_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.maximum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.minimum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_up_policy.2713412091.target", ""),
				),
			},
			{
				ResourceName: resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.policy_name", "policy-name"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.source", "cloudWatch"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.statistic", "average"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.unit", "percent"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.is_enabled", "false"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.cooldown", "60"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.dimensions.0.name", "name-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.dimensions.0.value", "value-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.threshold", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.operator", "lt"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.evaluation_periods", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.period", "60"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.action_type", "adjustment"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.adjustment", "MIN(5,10)"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.max_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.min_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.maximum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.minimum", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1495238087.target", ""),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckElastigroupAttributes(&group, groupName),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.policy_name", "policy-name-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.source", "spectrum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.statistic", "sum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.unit", "bytes"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.is_enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.cooldown", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.dimensions.0.name", "name-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.dimensions.0.value", "value-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.threshold", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.operator", "lt"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.evaluation_periods", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.period", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.action_type", "updateCapacity"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.minimum", "0"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.maximum", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.target", "5"),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.max_target_capacity", ""),
					resource.TestCheckResourceAttr(resourceName, "scaling_down_policy.1600322839.min_target_capacity", ""),
				),
			},
			{
				ResourceName: resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.policy_name", "policy-name"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.source", "cloudWatch"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.statistic", "average"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.unit", "percent"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.cooldown", "60"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.predictive_mode", "FORECAST_AND_SCALE"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.max_capacity_per_scale", "10"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.dimensions.0.name", "name-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.dimensions.0.value", "value-1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.target", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.evaluation_periods", "8"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.1740039296.period", "120"),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckElastigroupAttributes(&group, groupName),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.policy_name", "policy-name-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.metric_name", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.namespace", "AWS/EC2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.source", "spectrum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.statistic", "sum"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.unit", "bytes"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.cooldown", "120"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.predictive_mode", "FORECAST_ONLY"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.max_capacity_per_scale", "7"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.dimensions.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.dimensions.0.name", "name-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.dimensions.0.value", "value-1-update"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.target", "2.2"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.evaluation_periods", "6"),
					resource.TestCheckResourceAttr(resourceName, "scaling_target_policy.3247101471.period", "300"),
				),
			},
			{
				ResourceName: resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.delete_on_termination", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.device_name", "/dev/sdb"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.encrypted", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.iops", "1"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.snapshot_id", ""),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.volume_size", "12"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.volume_type", "GP3"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.2874541277.throughput", "500"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.delete_on_termination", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.device_name", "/dev/sda"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.encrypted", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.iops", "1"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.snapshot_id", ""),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.volume_size", "8"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.volume_type", "GP3"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.3569941340.throughput", "500"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.delete_on_termination", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.device_name", "/dev/sda"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.encrypted", "true"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.iops", "1"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.snapshot_id", ""),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.volume_size", "10"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.volume_type", "GP3"),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.4110604845.throughput", "500"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.hosted_zone_id", "id_create"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.record_sets.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.record_sets.3142519941.name", "test_create"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3700001715.record_sets.3142519941.use_public_ip", "false"),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.hosted_zone_id", "id_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.#", "3"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.324056474.name", "test_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.324056474.use_public_ip", "true"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.409274120.name", "test_update_two"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.409274120.use_public_ip", "false"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.2501457915.name", "test_update_three"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.983253016.record_sets.2501457915.use_public_ip", "false"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.hosted_zone_id", "new_domain_on_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.2228261234.name", "new_set"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.2228261234.use_public_ip", "true"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.4062604560.name", "test_update_default_ip"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.3115620618.record_sets.4062604560.use_public_ip", "false"),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.2712068702.hosted_zone_id", "id_create"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.2712068702.record_set_type", "cname"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.2712068702.record_sets.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.2712068702.record_sets.1411234404.name", "test_create"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.2712068702.record_sets.1411234404.use_public_dns", "true"),
				),
			},
			{
				ResourceName: resourceName,
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "integration_route53.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.hosted_zone_id", "id_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_set_type", "cname"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.#", "3"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.3843633722.name", "test_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.3843633722.use_public_dns", "true"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.4147622377.name", "test_update_two"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.4147622377.use_public_dns", "true"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.2051768602.name", "test_update_three"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1076157528.record_sets.2051768602.use_public_dns", "true"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1647748265.hosted_zone_id", "new_domain_on_update"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1647748265.record_set_type", "cname"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1647748265.record_sets.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1647748265.record_sets.1922635474.name", "new_set"),
					resource.TestCheckResourceAttr(resourceName, "integration_route53.0.domains.1647748265.record_sets.1922635474.use_public_dns", "true"),
				),
			},
			{
				ResourceName: resourceName,
